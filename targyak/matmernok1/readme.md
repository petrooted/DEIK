...
```js
A félév során minden témakörhöz gyakorló teszteket biztosítunk, ezek között lesznek olyanok, melyek megoldásával pluszpontokat lehet szerezni. 
A pluszpontok megszerzésére mindig  1 hét áll rendelkezésre, a tesztek megoldásával tetszőlegesen sokszor lehet próbálkozni. 
Ha a megadott időszakban legalább egyszer legalább 80%-osra sikerül egy ilyen tesztet megoldani, akkor ez 1 pluszpontot jelent.
```
```js
